...
class TestPyMuTT(unittest.TestCase):
    ...
    def test_get_expected_arguments(self):
        ...
        self.assertEqual(PyMuTT._get_expected_arguments(sum_class),
                         ('self', 'num1', 'num2'))
    ...
    def test_pass_expected_arguments(self):
        def sum_fn(num1, num2):
            return num1 + num2
        self.assertEqual(
            PyMuTT._pass_expected_arguments(sum_fn, **{'num1': 1, 'num2': 2}),
            3)
        ...
        self.assertEqual(PyMuTT._pass_expected_arguments(
            sum_class, **{'num1': 1, 'num2': 2}), sum_class(num1 = 1, num2 = 2))
        self.assertEqual(
            PyMuTT._pass_expected_arguments(
